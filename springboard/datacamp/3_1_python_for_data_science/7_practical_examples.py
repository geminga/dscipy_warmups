...
##### USE COUNTER TO DATE DATA IN CSV 
...
##### FLIP LIST TO KEYED DICT AND FILTER TO SHOW LOCATIONS WHERE STUFF HAPPENED IN 2016
# Import necessary modules
...
#### a nice group by count exercise
...
#### Not just csv reader, but DictReader - dict per row:
...
#### Arrests by district by year: MEINASIT UNOHTAA ITEMS() kun iteroit dictiä! Älä unohda!
